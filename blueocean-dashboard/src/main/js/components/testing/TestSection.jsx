...
export default class TestSection extends Component {
    ...
    render() {
        const { t: translation, locale, pager, extraClasses, total, titleKey } = this.props;
        ...
        if (total > 0) {
            result = (
                <div className={classes}>
                    ...
                    {pager.data.map((t, i) => <TestCaseResultRow key={i} testCase={t} translation={translation} locale={locale} />)}
